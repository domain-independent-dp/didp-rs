...
use dypdl_heuristic_search::{DualBoundDDS, FEvaluatorType, SolverParameters};
use std::error::Error;
use std::fmt;
use std::str;

pub fn load_from_yaml<T>(config: &yaml_rust::Yaml) -> Result<DualBoundDDS<T>, Box<dyn Error>>
where
