...
use super::search_algorithm::{Cbfs, SuccessorGenerator};
...
/// ```
/// use dypdl::prelude::*;
/// use dypdl_heuristic_search::{FEvaluatorType, create_dual_bound_cbfs};
...
///
/// let mut solver = create_dual_bound_cbfs(model, parameters, f_evaluator_type, None);
