...
/// Round-Robin Cyclic Best-First Search (RCBFS) solver using the dual bound.
///
...
pub struct DualBoundRRCBFS<T: variable_type::Numeric> {
...
impl<T> solver::Solver<T> for DualBoundRRCBFS<T>
where
