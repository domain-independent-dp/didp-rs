...
use super::search_algorithm::{DdLns, DdLnsParameters};
...
/// Create a Large Neighborhood Beam Search (DD-LNS) solver using the dual bound as a heuristic function.
///
...
/// ```
/// use dypdl::prelude::*;
/// use dypdl_heuristic_search::{FEvaluatorType, create_dual_bound_dd_lns};
/// use dypdl_heuristic_search::search_algorithm::util::Parameters;
/// use dypdl_heuristic_search::DdLnsParameters;
/// use std::rc::Rc;
///
...
///     model, parameters, dd_lns_parameters, f_evaluator_type, 1, false
/// );
