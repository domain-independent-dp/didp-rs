...
impl StateInRegistry {
    pub fn new(state: &dypdl::State) -> StateInRegistry {
        StateInRegistry {
...
impl dypdl::DPState for StateInRegistry {
    #[inline]
...
pub struct StateRegistry<'a, T: Numeric, I: StateInformation<T>> {
    ...
    metadata: &'a dypdl::StateMetadata,
...
impl<'a, T: Numeric, I: StateInformation<T>> StateRegistry<'a, T, I> {
    #[inline]
    pub fn new(model: &'a dypdl::Model) -> StateRegistry<T, I> {
        StateRegistry {
...
mod tests {
    ...
    fn state_getter() {
        ...
        let state = StateInRegistry::new(&dypdl::State {
