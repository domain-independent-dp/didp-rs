...
impl HashableSignatureVariables {
    pub fn new(variables: &dypdl::SignatureVariables) -> HashableSignatureVariables {
...
impl HashableResourceVariables {
    pub fn new(variables: &dypdl::ResourceVariables) -> HashableResourceVariables {
...
impl HashableState {
    pub fn new(state: &dypdl::State) -> HashableState {
        HashableState {
...
impl dypdl::DPState for HashableState {
    #[inline]
    ...
    fn apply_effect(&self, effect: &dypdl::Effect, registry: &dypdl::TableRegistry) -> Self {
    ...
    fn apply_effect_in_place(&mut self, effect: &dypdl::Effect, registry: &dypdl::TableRegistry) {
        for e in &effect.set_effects {
...
mod tests {
    ...
    fn state_getter() {
        ...
        let state = HashableState::new(&dypdl::State {
            ...
            resource_variables: dypdl::ResourceVariables {
                element_variables: vec![],
                integer_variables: vec![4, 5, 6],
                continuous_variables: vec![4.0, 5.0, 6.0],
            },
